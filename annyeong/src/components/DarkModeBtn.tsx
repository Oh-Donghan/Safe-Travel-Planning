  ...
  return (
    <label className='mr-2 sm:mr-4'>
      ...
      <svg
        ...
        className={`fill-my-bg w-7 h-7 transform transition duration-300 ease-in-out ${darkMode ? 'hidden' : 'block'} active:rotate-45 cursor-pointer`}
      ...
      <svg
        onClick={toggleDarkMode}
        className={`fill-my-text w-7 h-7 transform transition duration-300 ease-in-out ${darkMode ? 'block' : 'hidden'} active:rotate-45 cursor-pointer`}
        xmlns='http://www.w3.org/2000/svg'
        viewBox='0 0 24 24'
      >
